 ...
 */
 ...
 /*
  RELATIONSHIPS BETWEEN THE TABLES IN CUSTOMER TASKS:
...
-- MY SOLUTION (WITH SOME EXTRA STUFF ;D )
SELECT c.CUSTOMERNAME, o.ORDERID, e.FIRSTNAME || ' ' || e.LASTNAME AS"FULL NAME"
FROM ORDERS o
         INNER JOIN CUSTOMERS c ON o.CUSTOMERID = c.CUSTOMERID
         INNER JOIN EMPLOYEES e ON o.EMPLOYEEID = e.EMPLOYEEID;
...
SELECT  od. ORDERID , SUM(od.QUANTITY * p.PRICE ) AS "ORDER COST"
